...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
    ...
    if (nowGrp >= 2){ 
      str.append("<span class='span_box_1'><A href='"+listFile+"?nowPage="+_nowPage+"&memno="+memno+"'>이전</A></span>"); 
    } 
    ...
    if (nowGrp < totalGrp){ 
      str.append("<span class='span_box_1'><A href='"+listFile+"?nowPage="+_nowPage+"&memno="+memno+"'>다음</A></span>"); 
    } 
    str.append("</DIV>"); 
