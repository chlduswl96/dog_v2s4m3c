  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        <br>
        <button type='button' 
                    onclick="location.href='../oneinquiry/read.do?memno=${param.memno}&iqynum=${param.iqynum }'"
                    class="btn btn-default">업로드된 파일 확인</button>
        <button type='button' 
                    onclick="location.href='../oneinquiry/oneinquiry_list.do?memno=${param.memno}'"
