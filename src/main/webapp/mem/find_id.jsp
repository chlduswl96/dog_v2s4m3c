...
function find_id(){
	...
	$.ajax({
        ...
        dataType : 'json', // 응답형식
        data : "email=" + email,  // $("#frm").serialize(), : 서버로 전달하는 데이터
        success : function(rdata) {
          var msg = "'" + email + "'로 id를 보냈습니다.";
            
          $('#find_content').attr('class', 'alert alert-success');
          $('#find_title').html('아이디 찾기');
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal" onclick="location.href='./login.do'">확인</button>
          <button type="button" class="btn btn-default" data-dismiss="modal">다른 email로 찾기</button>
        </div>
      </div>
...
<DIV class='message' style='width: 90%;'>
      ...
      <div class="col-md-10" style='text-align: center;'>
        ...
        <button type='button' onclick="find_id()" class="btn btn-info btn-md">찾기</button>
      </div>
    </div> 
</DIV>
