...
<c:set var="attachno" value="${attachfileVO.attachno}" />
            ...
            <c:forEach var="attachfileVO" items="${attachfile_list }">
              ...
              <c:choose>
                <c:when test="${thumb.endsWith('jpg') || thumb.endsWith('png') || thumb.endsWith('gif')}">
                  ...
                  <A href="./file_delete_proc.do?noticeno=${noticeno}&attachno=${attachfileVO.attachno }"><span class="glyphicon glyphicon-remove"></span></A>
                </c:when>
              </c:choose>
            </c:forEach>
          </li>
          <li class="li_center" >
            <button type="button" onclick="location.href='./read.do?noticeno=${noticeno}'"
